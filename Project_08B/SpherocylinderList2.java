...
////////////////////////////////////////////////////////////
  ...
  */   
   public boolean editSpherocylinder(String labelIn, double radiusIn,
                                     double heightIn) {
      String test = labelIn.toUpperCase();
      boolean result = false;
      int spot = 0;
      
      for (int i = 0; i < numElements; i++) {
         if (listSC[i].getLabel().toUpperCase().equals(test)) {
...
//////////////////////////////////////////////////////////////
  ...
  /**
   * Returns the Spherocylinder with the shortest radius. 
   * @return x returns the spherocylinder
  */
   public Spherocylinder findSpherocylinderWithShortestRadius() {
      double smallest = listSC[0].getRadius();
      Spherocylinder x = new Spherocylinder();
   
      if (numElements > 0) {
         for (int i = 0; i < numElements; i++) {
            if (listSC[i].getRadius() <= smallest) {
               smallest = listSC[i].getRadius();
               x = listSC[i];
            }
         }
      }
  ...
  /**
   * Returns the Spherocylinder with the largest radius. 
   * @return x returns the spherocylinder
  */   
   public Spherocylinder findSpherocylinderWithLongestRadius() {
      double largest = listSC[0].getRadius();
      Spherocylinder x = new Spherocylinder();
   
      if (numElements > 0) {
         for (int i = 0; i < numElements; i++) {
            if (listSC[i].getRadius() >= largest) {
               largest = listSC[i].getRadius();
               x = listSC[i];
            }
         }
      }
  ...
  /**
   * Returns the Spherocylinder with the smallest volume. 
   * @return x returns the spherocylinder
  */   
   public Spherocylinder findSpherocylinderWithSmallestVolume() {
      double smallest = listSC[0].volume();
      Spherocylinder x = new Spherocylinder();
   
      if (numElements > 0) {
         for (int i = 0; i < numElements; i++) {
            if (listSC[i].volume() <= smallest) {
               smallest = listSC[i].volume();
               x = listSC[i];
            }
         }
      }
  ...
  */
   public Spherocylinder findSpherocylinderWithLargestVolume() {
      double largest = listSC[0].volume();
      Spherocylinder x = new Spherocylinder();
   
      if (numElements > 0) {
         for (int i = 0; i < numElements; i++) {
            if (listSC[i].volume() >= largest) {
               largest = listSC[i].volume();
               x = listSC[i];
            }
         }
      }
